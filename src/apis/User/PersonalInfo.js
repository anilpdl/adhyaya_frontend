...
const URLS = {
  INDEX: `${apiUrlConfig.apiEndPoint()}/personal_info/:id`,
  ADD: `${apiUrlConfig.apiEndPoint()}/personal_info/:id/add`,
  UPDATE: `${apiUrlConfig.apiEndPoint()}/personal_info/:id/update`,
  FETCH: `${apiUrlConfig.apiEndPoint()}/user/:userId/personal_info`,
};
